...
class WxPayUnifiedOrder extends WxPayDataBase
{
    ...
    /****/
    public function set_mch_appId($value){
        $this->values['mch_appid'] = $value;
    }
    public function set_mchid($value){
        $this->values['mchid'] = $value;
    }
    public function set_partner_trade_no($value){
        $this->values['partner_trade_no'] = $value;
    }
    public function set_check_name($value){
    ...
    public function set_spbill_create_ip($value){
        $this->values['spbill_create_ip'] = $value;
    }
    /**
     * 设置微信支付分配的商户号
