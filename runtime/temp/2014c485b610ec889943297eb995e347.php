        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="row">
                    ...
                    <a href="add-format.html"><button type="button" class="btn btn-sm btn-danger" data-toggle="modal">
                ...
                <div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                <?php if(isset($format_list)): if(is_array($format_list) || $format_list instanceof \think\Collection || $format_list instanceof \think\Paginator): if( count($format_list)==0 ) : echo "" ;else: foreach($format_list as $key=>$format): ?>
                                        <tr valign="middle">
                                            <td class="hidden-480">
                                                <span class="badge badge-grey"><?php echo $format['format_id']; ?></span>
                                            </td>
                                            <td>
                                                <?php echo $format['format_name']; ?>
                                            </td>
                                            <td>
                                                <?php if(!(empty($format['format_value']) || (($format['format_value'] instanceof \think\Collection || $format['format_value'] instanceof \think\Paginator ) && $format['format_value']->isEmpty()))): $f_value_list = unserialize($format['format_value']); if(is_array($f_value_list) || $f_value_list instanceof \think\Collection || $f_value_list instanceof \think\Paginator): if( count($f_value_list)==0 ) : echo "" ;else: foreach($f_value_list as $key=>$val): ?>
                                                        <span class="badge badge-grey"><?php echo $val; ?></span>
                                                    <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                                            </td>
                                            <td class="hidden-480">
                                                <span class="label label-warning"><?php echo $format['format_time']; ?></span>
                                            </td>
                                            <td class="hidden-480">
                                                <input type="number" class="input-small" value="<?php echo $format['format_order']; ?>"/>
                                            </td>
                                            <td>
                                                <?php if($format['format_open'] == '20'): ?>
                                            ...
                                            <td>
                                                <a href="edit-format.html?eid=<?php echo $format['format_id']; ?>"><button class="btn btn-xs btn-info" data-toggle="modal">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </button></a>
                                                <button class="btn btn-xs btn-danger bootbox-del" data-id="<?php echo $format['format_id']; ?>">
                    ...
                    if(result) {
                        ...
                        $.ajax({
                            ...
                            success:function(re){
                                if(re.code==200){
                                    window.alert(re.msg);
                                    window.location.href="p_format.html";
                                }else{
                                    window.alert(re.msg);
                                    return false;
                                }
