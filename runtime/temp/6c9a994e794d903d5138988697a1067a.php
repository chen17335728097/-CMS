...
<div id="sidebar2" class="sidebar h-sidebar navbar-collapse collapse collapse_btn" data-sidebar="true">
...
<i class="ace-icon fa fa-hand-o-right"></i> 请您配置站点基本信息
...
<form class="form-horizontal" name="sys" id="sys" method="post" action="parameter.html" enctype="multipart/form-data">
<input type="hidden" name="id" value="<?php echo $info['id']; ?>">
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 网站名称 </label>
<div class="col-sm-9">
<input type="text" name="web_name" id="sys_name" value="<?php echo $info['web_name']; ?>" class="col-xs-12 col-sm-5">
...
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 网站24小时服务热线 </label>
<div class="col-sm-9">
<input type="text" name="web_hot_line" id="web_hot_line" value="<?php echo $info['web_hot_line']; ?>" class="col-xs-12 col-sm-5">
<span class="help-inline col-xs-12 col-sm-7">
<span class="middle" id="resone"></span>
</span>
</div>
...
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 网站联系电话 </label>
<div class="col-sm-9">
<input type="text" name="web_tel" id="web_tel" value="<?php echo $info['web_tel']; ?>" class="col-xs-12 col-sm-5">
<span class="help-inline col-xs-12 col-sm-7">
<span class="middle" id="resone"></span>
</span>
</div>
...
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 联系QQ </label>
<div class="col-sm-9">
<input type="text" name="web_qq" id="web_qq" value="<?php echo $info['web_qq']; ?>" class="col-xs-12 col-sm-5">
<span class="help-inline col-xs-12 col-sm-7">
<span class="middle" id="resone"></span>
</span>
</div>
...
<div class="space-4"></div>
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 联系人手机 </label>
<div class="col-sm-9">
<input type="text" name="web_phone" id="web_phone" value="<?php echo $info['web_phone']; ?>" class="col-xs-12 col-sm-5">
<span class="help-inline col-xs-12 col-sm-7">
<span class="middle" id="resone"></span>
</span>
</div>
...
<div class="space-4"></div>
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 公司邮箱email </label>
<div class="col-sm-9">
<input type="text" name="web_email" id="web_email" value="<?php echo $info['web_email']; ?>" class="col-xs-12 col-sm-5">
<span class="help-inline col-xs-12 col-sm-7">
<span class="middle" id="resone"></span>
</span>
</div>
...
<div class="col-sm-9">
<input type="text" name="web_address" id="web_address" value="<?php echo $info['web_address']; ?>" class="col-xs-12 col-sm-5">
<span class="help-inline col-xs-12 col-sm-7">
<span class="middle" id="resone"></span>
</span>
</div>
...
<div class="space-4"></div>
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 站点URL </label>
<div class="col-sm-9">
<input type="text" name="web_url" id="sys_url" value="<?php echo $info['web_url']; ?>" class="col-xs-12 col-sm-5">
<span class="help-inline col-xs-12 col-sm-7">
...
<div class="col-sm-11">
<?php if(empty($info['web_logo']) || (($info['web_logo'] instanceof \think\Collection || $info['web_logo'] instanceof \think\Paginator ) && $info['web_logo']->isEmpty())): ?>
<img src="__STATIC__/assets/images/no_img.jpg" width="100" height="70">
<?php else: ?>
<img src="__PUBLIC__/<?php echo $info['web_logo']; ?>" width="100" height="70">
<?php endif; ?>
</div>
</div>
</div>
...
<!--<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 微信公众号二维码 </label>
<div class="col-sm-9">
<div class="col-xs-12 col-sm-5 no-padding">
<input type="file" id="id-input-file-3" name="wx_logo"/>
</div>
<div class="col-sm-11">
<?php if(empty($info['web_wx_logo']) || (($info['web_wx_logo'] instanceof \think\Collection || $info['web_wx_logo'] instanceof \think\Paginator ) && $info['web_wx_logo']->isEmpty())): ?>
<img src="__STATIC__/assets/images/no_img.jpg" width="100" height="70">
<?php else: ?>
<img src="__PUBLIC__/<?php echo $info['web_wx_logo']; ?>" width="100" height="70">
<?php endif; ?>
</div>
</div>
</div>
...
<div class="col-sm-9">
<input type="text" name="web_title" id="sys_title" value="<?php echo $info['web_title']; ?>" class="col-xs-12 col-sm-5">
<span class="help-inline col-xs-12 col-sm-7">
...
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 网站关键词 </label>
<div class="col-sm-9">
<textarea name="web_keywords" cols="20" class="col-xs-12 col-sm-7 limited" id="form-field-9" maxlength="100"><?php echo $info['web_title']; ?></textarea>

<span class="help-inline col-xs-5 col-sm-5">
还可以输入 <span class="middle charsLeft">89</span> 个字符,以英文 , 号隔开
</span>
</div>
</div>
<div class="space-4"></div>
...
<div class="col-sm-9">
<textarea name="web_desc" cols="20" max-length="200" class="col-xs-12 col-sm-7 limitedone" maxlength="200"><?php echo $info['web_desc']; ?></textarea>

<span class="help-inline col-xs-5 col-sm-5">
还可以输入 <span class="middle charsLeftone">189</span> 个字符
</span>
</div>
</div>
<div class="hr hr-dotted"></div>
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 底部版权 </label>
<div class="col-sm-9">
<textarea name="web_footer" cols="20" class="col-xs-12 col-sm-7 limitedone" id="form-field-10" maxlength="200"><?php echo $info['web_footer']; ?></textarea>
</div>
</div>
<div class="space-4"></div>

<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 技术支持 </label>
<div class="col-sm-9">
<input type="text" value="<?php echo $info['web_technology']; ?>" class="col-xs-12 col-sm-5" name="web_technology">
</div>
...
<div class="col-sm-9">
<input type="text" value="<?php echo $info['web_tech_url']; ?>" class="col-xs-12 col-sm-5" name="web_tech_url" >
</div>
</div>
<div class="space-4"></div>
...
<div class="col-sm-9">
<input type="text" value="<?php echo $info['web_icp']; ?>" class="col-xs-12 col-sm-5" name="web_icp" >
</div>
</div>
<div class="space-4"></div>
...
<div class="col-sm-9">
<textarea name="web_census" rows="10" class="col-xs-12 col-sm-7 limitedone" placeholder="添加百度统计,百度商桥"><?php echo $info['web_census']; ?></textarea>
...
var file_input = $('#id-input-file-2,#id-input-file-3');
file_input
