			...
			<div class="page-content">
				...
				<div class="row">
					...
					<table class="table table-bordered table-hover">
						...
						<tbody>
						<?php if(is_array($admin_list) || $admin_list instanceof \think\Collection || $admin_list instanceof \think\Paginator): if( count($admin_list)==0 ) : echo "" ;else: foreach($admin_list as $key=>$admin): ?>
						<tr>
							<td><?php echo $admin['username']; ?></td>

							<td><?php echo $admin['true_name']; ?></td>
							<td class="hidden-480"><?php echo $admin['mobile']; ?></td>
							<td><?php echo $admin['login_num']; ?></td>
							<td class="hidden-480">1.199.74.31</td>
							<!--<td>
							...
							<td>
								<button class="btn btn-xs btn-info" data-toggle="modal" data-id="<?php echo $admin['id']; ?>" data-target="#edit-ad">
									<i class="ace-icon fa fa-pencil bigger-120"></i>
								</button>
								<button class="btn btn-xs btn-danger bootbox-del"  data-id="<?php echo $admin['id']; ?>" >
...
<div class="modal fade" id="add-ad" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form class="form-horizontal ajaxForm2" name="plug_ad_add" method="post" action="admin_save.html">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select name="group_id" class="col-sm-8 col-xs-12 selector" required>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 登录账户：  </label>
								<div class="col-sm-8">
									<input type="text" name="username" id="plug_ad_name" placeholder="输入登录账户" class="col-xs-12 col-sm-8" required/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 登录密码：  </label>
								<div class="col-sm-8">
									<input type="password" name="password" placeholder="输入登录密码" class="col-xs-12 col-sm-8" required/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="email" name="email" placeholder="输入用户邮箱" class="col-xs-12 col-sm-8" required/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="tel" name="mobile" placeholder="输入手机号" class="col-xs-12 col-sm-8" required/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="true_name" placeholder="输入真实姓名" class="col-xs-12 col-sm-8" required/>
								</div>
							</div>
						</div>
					</div>
...
<div class="modal fade" id="edit-ad" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form class="form-horizontal ajaxForm2" name="plug_ad_add" method="post" action="adminSave.html">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 所属用户组： </label>
								<div class="col-sm-8">
									<select name="group_id" id="edit_group_id" class="col-sm-8 col-xs-12 selector" required>
										<option value="">请选择所属用户组</option>
										<?php if(is_array($group_list) || $group_list instanceof \think\Collection || $group_list instanceof \think\Paginator): if( count($group_list)==0 ) : echo "" ;else: foreach($group_list as $key=>$group): ?>
										<option value="<?php echo $group['id']; ?>"><?php echo $group['title']; ?></option>
										<?php endforeach; endif; else: echo "" ;endif; ?>
							...
							<input type="hidden" name="aid" value="" id="edit_id" />
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 登录账户：  </label>
								<div class="col-sm-8">
									<input type="text" name="username" id="edit_username"  value=""  id="plug_ad_name" placeholder="输入登录账户" class="col-xs-12 col-sm-8" required/>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 登录密码：  </label>
								<div class="col-sm-8">
									<input type="text" name="password" id="edit_password" value=""  placeholder="输入登录密码(不输入默认不修改)" class="col-xs-12 col-sm-8"/>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 用户邮箱：  </label>
								<div class="col-sm-8">
									<input type="email" name="email" id="edit_email" value="" placeholder="输入用户邮箱" class="col-xs-12 col-sm-8" required/>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 手机号：  </label>
								<div class="col-sm-8">
									<input type="tel" name="mobile" id="edit_phone" value="" placeholder="输入手机号" class="col-xs-12 col-sm-8" required/>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 真实姓名：  </label>
								<div class="col-sm-8">
									<input type="text" name="true_name" id="edit_true_name" value="" placeholder="输入真实姓名" class="col-xs-12 col-sm-8" required/>
								</div>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	jQuery(function($) {
		//获取编辑信息
		var menu= new Object(<?php echo $menuObj; ?>);
		...
		$(".btn-info").on('click',function(){
			...
			if(menu !=""){
				for(var info in menu){
					var mid = menu[info].id;
					if(mid==editid){
						$("#edit_id").val(mid);
						$("#edit_username").val(menu[info].username);
						$("#edit_email").val(menu[info].email);
						$("#edit_phone").val(menu[info].mobile);
						$("#edit_true_name").val(menu[info].true_name);
						return true;
					}
				}
			}
