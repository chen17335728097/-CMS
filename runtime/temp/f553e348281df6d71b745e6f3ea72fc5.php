    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal ajaxForm2" action="editProduct.html" method="post" enctype="multipart/form-data" name="form-product" id="form-product">
                            <div class="form-group">
                                <input name="product_id" type="hidden" value="<?php echo $info['product_id']; ?>">
                                    ...
                                    <select name="pc_id" class="col-sm-6 selector">
                                        <option value="">请选择商品分类</option>
                                                <?php if(is_array($class) || $class instanceof \think\Collection || $class instanceof \think\Paginator): if( count($class)==0 ) : echo "" ;else: foreach($class as $key=>$p_class): ?>
                                                    <option <?php if($p_class['pc_id'] == $info['pc_id']): ?>selected="selected"<?php endif; ?> value="<?php echo $p_class['pc_id']; ?>">├├<?php echo $p_class['pc_name']; ?></option>
                                                     <?php if(isset($p_class['two'])): if(is_array($p_class['two']) || $p_class['two'] instanceof \think\Collection || $p_class['two'] instanceof \think\Paginator): if( count($p_class['two'])==0 ) : echo "" ;else: foreach($p_class['two'] as $key=>$pc2): ?>
                                                            <option <?php if($pc2['pc_id'] == $info['pc_id']): ?>selected="selected"<?php endif; ?> value="<?php echo $pc2['pc_id']; ?>">├├├├<?php echo $pc2['pc_name']; ?></option>
                                                                <?php if(isset($p_class['three'])): if(is_array($pc2['three']) || $pc2['three'] instanceof \think\Collection || $pc2['three'] instanceof \think\Paginator): if( count($pc2['three'])==0 ) : echo "" ;else: foreach($pc2['three'] as $key=>$pc3): ?>
                                                                        <option <?php if($pc3['pc_id'] == $info['pc_id']): ?>selected="selected"<?php endif; ?> value="<?php echo $pc3['pc_id']; ?>">├├├├├├<?php echo $pc3['pc_name']; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 no-padding">
                                    <div class="col-xs-10 col-sm-6">
                                        <input type="text" name="product_name" value="<?php echo $info['product_name']; ?>" id="pro_title" placeholder="请输入商品名称,不能超过30个字" class="form-control" required="">
                                    </div>
                       ...
                       <!--     <div class="form-group">
                                ...
                                <div class="col-sm-10 no-padding">
                                    <div class="col-xs-10 col-sm-6">
                                        <input type="text" name="product_sale_promotion" value="<?php echo $info['product_sale_promotion']; ?>" id="pro_sale_promotion" placeholder="请输入促销语,不能超过60个字" class="form-control">
                                    </div>
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resone"></span>
											</span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 no-padding">
                                    <div class="col-xs-10 col-sm-6">
                                        <input type="text" name="product_keywords" value="<?php echo $info['product_keywords']; ?>" id="pro_keywords" placeholder="商品关键词,用于SEO搜索" class="form-control">
                                    </div>
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resone"></span>
											</span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 no-padding">
                                    <div class="col-xs-10 col-sm-6">
                                        <select name="supplier_id" class="col-sm-6 selector">
                                            ...
                                            <?php if(is_array($supplier_list) || $supplier_list instanceof \think\Collection || $supplier_list instanceof \think\Paginator): if( count($supplier_list)==0 ) : echo "" ;else: foreach($supplier_list as $key=>$supplier): ?>
                                                <option <?php if($supplier['supplier_id'] == $info['supplier_id']): ?>selected="selected"<?php endif; ?> value="<?php echo $supplier['supplier_id']; ?>" class="bgc">├├<?php echo $supplier['supplier_name']; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 no-padding">
                                    <div class="col-xs-10 col-sm-6">
                                        <select name="brand_id" class="col-sm-6 selector">
                                            ...
                                            <?php if(isset($brand)): if(is_array($brand) || $brand instanceof \think\Collection || $brand instanceof \think\Paginator): if( count($brand)==0 ) : echo "" ;else: foreach($brand as $key=>$b): ?>
                                                    <option <?php if($b['brand_id'] == $info['brand_id']): ?>selected="selected"<?php endif; ?> value="<?php echo $b['brand_id']; ?>" class="bgc">├├├├<?php echo $b['brand_name']; ?></option>
                                ...
                                <div class="col-sm-10 no-padding">
                                    <div class="col-xs-10 col-sm-6">
                                        <select name="product_recommend" class="col-sm-6 selector">
                                            ...
                                            <option <?php if($info['product_recommend'] == '10'): ?>selected="selected"<?php endif; ?>value="10">普通商品</option>
                                            <option <?php if($info['product_recommend'] == '20'): ?>selected="selected"<?php endif; ?>value="20">置顶商品</option>
                                            <option <?php if($info['product_recommend'] == '30'): ?>selected="selected"<?php endif; ?>value="30">人气商品</option>
                                            <option <?php if($info['product_recommend'] == '40'): ?>selected="selected"<?php endif; ?>value="40">推荐商品</option>
                                            <option <?php if($info['product_recommend'] == '50'): ?>selected="selected"<?php endif; ?>value="50">积分商品</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 no-padding">
                                    <div class="col-xs-10 col-sm-6">
                                        <input type="text" name="product_point" id="pro_point" placeholder="" class="form-control">
                                    </div>
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 no-padding">
                                    <div class="col-xs-4 col-sm-2">
                                      <!--  市场价：-->
                                        <input type="number" name="product_market_price" value="<?php echo $info['product_market_price']; ?>" class="input-small" required>元
                                    </div>
                                    <!--<div class="col-xs-4 col-sm-2">
                                        销售价：
                                        <input type="number" name="product_sale_price" value="<?php echo $info['product_sale_price']; ?>" class="input-small" required>元
                                    </div>
                                    <div class="col-xs-4 col-sm-2">
                                        成本价：
                                        <input type="number" name="product_base_price" value="<?php echo $info['product_base_price']; ?>" class="input-small" required>元
                                    </div>
                                    <div class="col-xs-4 col-sm-2">
                                        会员价：
                                        <input type="number" name="product_member_price" value="<?php echo $info['product_member_price']; ?>" class="input-small" required>元
                                    </div>-->
                                </div>
                            </div>
                            <div class="space-4"></div>
                         <!--   <div class="form-group">
                                ...
                                <div class="col-sm-10 no-padding">
                                    <div class="col-xs-4 col-sm-2">
                                        基础销量：
                                        <input type="number" name="product_base_sale_count" value="<?php echo $info['product_base_sale_count']; ?>" placeholder="默认15246" class="input-small">
                                    </div>
                                    <div class="col-xs-4 col-sm-2">
                                        基础点计量：
                                        <input type="number" name="product_base_hits_count" placeholder="默认852" value="<?php echo $info['product_base_hits_count']; ?>" class="input-small">
                                    </div>
                                    <div class="col-xs-4 col-sm-2">
                                        基础分享数：
                                        <input type="number" name="product_base_shave_count" placeholder="默认368" value="<?php echo $info['product_base_shave_count']; ?>" class="input-small">
                                    </div>
                                    <div class="col-xs-4 col-sm-2">
                                        总库存：
                                        <input type="number" name="product_account" placeholder="默认999999999" value="<?php echo $info['product_account']; ?>" class="input-small">
                                    </div>
                                    <div class="col-xs-4 col-sm-2">
                                        库存预警：
                                        <input type="number" name="product_call_count" placeholder="默认150" value="<?php echo $info['product_call_count']; ?>" class="input-small">
                                    </div>
                                </div>
                            </div>-->
                            <div class="space-4"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" style="width:65%;" id="edit_box">
                                    <?php if(is_array($format_list) || $format_list instanceof \think\Collection || $format_list instanceof \think\Paginator): if( count($format_list)==0 ) : echo "" ;else: foreach($format_list as $key=>$format): ?>
                                        <input type="checkbox" name="format_id[]"  <?php if(in_array(($format['format_id']), is_array($info['format_id'])?$info['format_id']:explode(',',$info['format_id']))): ?> checked <?php endif; ?>  value="<?php echo $format['format_id']; ?>" style="width: 20px;height: 20px;margin-top:10px;"/>
                                        <label>&nbsp;<?php echo $format['format_name']; ?>&nbsp;</label>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                    <input type="button" value="确定" id="confirm_type">
                                    <?php if(isset($product_attr_format)): if(is_array($product_attr_format) || $product_attr_format instanceof \think\Collection || $product_attr_format instanceof \think\Paginator): if( count($product_attr_format)==0 ) : echo "" ;else: foreach($product_attr_format as $key=>$attr_format): ?>
                                            <div class='col-sm-4' id='attr_box_<?php echo $key; ?>' style='width:100%;float: left;margin: 30px;'>
                                                <input type='input' readonly name='format_list_name[]' style='min-width:150px;'  value='<?php echo $attr_format['attr_value']; ?>' class='input-small' >&nbsp;
                                                <!--市场价：--><input type='number' name='format_market_price[]' style='max-width:150px' value='<?php echo $attr_format['attr_market_price']; ?>' class='input-small' >
                                                <!--销售价：<input type='number' name='format_sale_price[]' style='max-width:150px'  value='<?php echo $attr_format['attr_sale_price']; ?>' class='input-small' >
                                                成本价：<input type='number' name='format_base_price[]' style='max-width:150px'  value='<?php echo $attr_format['attr_base_price']; ?>' class='input-small' >
                                                会员价：<input type='number' name='format_member_price[]'  style='max-width:150px' value='<?php echo $attr_format['attr_member_price']; ?>' class='input-small' >
                                                积分价：<input type='number' name='attr_point[]'  style='max-width:150px' value='<?php echo $attr_format['attr_point']; ?>' class='input-small' >-->
                                            </div>
                                        <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 no-padding">
                                    <div class="col-sm-4">
                                        <input type="file" name="file_logo" id="id-input-file-4"/>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="product_scontent" value="<?php echo $info['product_scontent']; ?>" class="col-xs-10 col-sm-10" maxlength="100" placeholder="已限制在100个字以内">
                                </div>
                            </div>
                            <div class="space-4"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <textarea name="product_content" style="width:100%;" id="myEditor"><?php echo $info['product_content']; ?></textarea>
                                    <script type="text/javascript">
...
<script type="text/javascript">
    $(function () {
        ...
        $("#confirm_type").on('click',function(){
            ob.length = 0;
            $(".col-sm-10 input:checkbox").each(function () {
                        ...
                        if(res){
                            for(var dex in res){
                                var input = "<div class='col-sm-4' id='attr_box"+dex+"' style='width:100%;float: left;margin: 30px;'>"+
                                        ...
                                        "市场价：<input type='number' name='format_market_price[]' style='max-width:150px' value='' class='input-small' >"+
                                        ...
                                        "积分价：<input type='number' name='attr_point[]'  style='max-width:150px' value='' class='input-small' ></div>";
